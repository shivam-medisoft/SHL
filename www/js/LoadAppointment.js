...
//    }
   ...
   var path = localStorage.ipadrs;
    ...
    $.post(path, function (responseText) {
        debugger;
        try{
...
//        });
                ...
                if(id.title.indexOf("SH:QRY")>=0){
                    ...
                    $.post(path+'/TestingSchedule?webid='+webid+'&type=validation&id='+id.id+'&scrdata='+scrdata+'&unicid='+unic,function(responcejson){
                        if(responcejson!=""&&responcejson!=null){
                            if(responcejson.indexOf("@")>=0){
                                debugger;
...
//                var date=document.getElementById(dateid).value;
                ...
                var servertm="";
                var systm="";
                $.post(path+'/TestingSchedule?type=chktime&webid='+webid+'&allflg='+allflg+'&time='+id.title+'&date='+date,function(responcejson1){
                if(responcejson1!=""){
                ...
                if(allflg=="true"){
                $.post(path+'/TestingSchedule?type=cleargrid&webid='+webid,function(responcejson){
                    if(responcejson!="" && responcejson!=null){
                        debugger;
...
//                                alert(id);
    ...
    debugger;
     if(responcejson!=null){
                        document.getElementById("txtunicid").value=responcejson;
                        //                        populatesc();
                    }
                    else{
                        //                        populatesc();
...
//                });
            ...
            localStorage.drillwebchain = "1";
                var path = localStorage.ipadrs;
                var webid=document.getElementById("webid").value;
                $.post(path+'/TestingSchedule?type=chkman&webid='+webid,function(responcejson){
                    if(responcejson!="" && responcejson!=null){
            ...
            function save1(flg,exeqry){
                ...
                var scrdata=document.getElementById("scrdata").value;
                 document.getElementById("mydiv").style.display="block";
                $.post(path+'/TestingSchedule?type=getdata&webid='+webid+'&flg='+flg,function(responceJson){
                    if(responceJson!=""&& responceJson!=null){
                        debugger;
...
//                    alert(flg);
            ...
            location.href = 'PaymentGetway.html';
                        ...
                        $.post(data,function(responceJson){
                        debugger;
