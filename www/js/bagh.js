...
function getConnection() {
    try {
        if (!CheckConnection()) {
            ...
            hello.greet("bagh", successmah, failuremah);
        }

    } catch (err) {
        localStorage.mahappurl = "http://localhost:8888/bagh/";
        localStorage.mah = '1';
        localStorage.appname = "bagh";
    }
