...
function getConnection() {
    try {
        if (!CheckConnection()) {
            ...
            hello.greet("ujalacygnus", successmah, failuremah);
        }

    } catch (err) {
        localStorage.mahappurl = "http://localhost:8888/ujalacygnus/";
        localStorage.mah = '1';
        localStorage.appname = "ujalacygnus";
    }
    ...
    $.ajax({
        ...
        success: function (responseJson) {
            if (responseJson.length > 0) {
                ...
                localStorage.formid = 'ujalacygnus';
