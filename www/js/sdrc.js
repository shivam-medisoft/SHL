...
function getConnection() {
    try {
        if (!CheckConnection()) {
            ...
            hello.greet("sdrc", successmah, failuremah);
        }

    } catch (err) {
        localStorage.mahappurl = "http://localhost:8888/sdrc/";
        localStorage.mah = '1';
        localStorage.appname = "sdrc";
    }
