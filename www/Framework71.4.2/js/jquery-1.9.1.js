...
function notifymsg(msg) {
	...
	var exitappname = "Shivam Dashboard";
                                    if (localStorage.appname === 'fernandez') {
                                        ...
                                        exitappname = "UCH MyHealth- New Notification";
                                    }else if (localStorage.appname === 'shl') {
                                        exitappname = "Sahyadri Hospitals- New Notification";
                                    }else if (localStorage.appname === 'sdrc') {
                                        exitappname = "SDRC - New Notification";
                                    }else if (localStorage.appname === 'bagh') {
                                        exitappname = "BAGH - New Notification";
                                    }
        playBeepn();
