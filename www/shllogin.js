...
for (country of countries) {
    ...
    select_box.querySelector('#countryCodes').insertAdjacentHTML('beforeend', option);
...
function Editotplite(e){
debugger;

if(document.getElementById('passwordSecond').value !==''){
    $('.sendOtp-second-div').css('display','block')

    let getnumbervalue=$('#passwordSecond').val();
    $('.otppasswordSecond').attr('value',getnumbervalue);
    var myotp=document.querySelectorAll('.otpfourboxp > input');
...
function myFunction(element){
  ...
  document.querySelector('.page-modal > .modal-container').style.display = 'none';
  document.querySelector('.page-modal-second').style.display = 'block';
  ...
  setTimeout(function() {
    ...
    if (passwordSecond) {
      ...
      console.log('Element not found or not visible yet');
    }
  }, 5000);
}
document.getElementById('password').addEventListener('touchend', function() {
  myFunction(this);
})